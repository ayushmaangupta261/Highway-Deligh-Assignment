...
// import { getNotes, createNoteAPI, deleteNoteAPI, updateNoteAPI, shareNoteAPI } from "../services/operations/notesApi";
...
//   const [isEditingAllowed, setIsEditingAllowed] = useState(true); // For distinguishing own vs shared note
...
//       if (selectedNote) {
//         const res = await updateNoteAPI(selectedNote._id, {
//           title: newNote.title,
